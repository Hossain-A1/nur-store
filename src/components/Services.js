  ...
  return (
    <section className='wrapper section-p'>
      <div className='grid grid-cols-3 gap-5'>
        <div className='delivery-1 text-center shadow   flex flex-col justify-center items-center bg-slate-100 rounded-lg col-span-1 gap-2'>
        ...
        <div className='delivery-2  flex flex-col justify-center gap-5 p-5 items-center col-span-1'>
          <div className='bg-slate-100 flex gap-3 p-5 justify-center items-center rounded-lg'>
            <div className="p-5 bg-slate-50 rounded-full">
        ...
        <div className='delivery-3  text-center shadow  col-span-1 flex flex-col justify-center items-center bg-slate-100 rounded-lg'>
